...
model CheckTemperature "Test model for CheckTemperature"
  ...
  IBPSA.BoundaryConditions.WeatherData.BaseClasses.CheckDryBulbTemperature
...
__Dymola_Commands(file=
          "modelica://IBPSA/Resources/Scripts/Dymola/BoundaryConditions/WeatherData/BaseClasses/Examples/CheckTemperature.mos"
        "Simulate and plot"));
