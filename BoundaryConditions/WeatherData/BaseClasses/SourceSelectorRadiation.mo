within CoSES_Thermal_ProHMo_PHiL.BoundaryConditions.WeatherData.BaseClasses;
block SourceSelectorRadiation
  ...
  parameter IBPSA.BoundaryConditions.Types.RadiationDataSource datSou "Data source"
  ...
  Modelica.Blocks.Interfaces.RealInput HDirNorIn(
    final quantity="RadiantEnergyFluenceRate",
    final unit="W/m2")
   if datSou == IBPSA.BoundaryConditions.Types.RadiationDataSource.Input_HDirNor_HDifHor or
  ...
  Modelica.Blocks.Interfaces.RealInput HDifHorIn(
    final quantity="RadiantEnergyFluenceRate",
    final unit="W/m2")
  if datSou == IBPSA.BoundaryConditions.Types.RadiationDataSource.Input_HGloHor_HDifHor or
