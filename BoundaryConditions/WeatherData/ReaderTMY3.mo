within CoSES_Thermal_ProHMo_PHiL.BoundaryConditions.WeatherData;
block ReaderTMY3 "Reader for TMY3 weather data"
 ...
 if (TBlaSkySou == IBPSA.BoundaryConditions.Types.DataSource.Input)
  ...
  Modelica.Blocks.Interfaces.RealInput HGloHor_in(
    final quantity="RadiantEnergyFluenceRate",
    final unit="W/m2")
      if (HSou == IBPSA.BoundaryConditions.Types.RadiationDataSource.Input_HGloHor_HDifHor or
  ...
  Modelica.Blocks.Interfaces.RealInput HDirNor_in(final quantity="RadiantEnergyFluenceRate",
      final unit="W/m2")
      if (HSou == IBPSA.BoundaryConditions.Types.RadiationDataSource.Input_HDirNor_HDifHor or
          HSou == IBPSA.BoundaryConditions.Types.RadiationDataSource.Input_HDirNor_HGloHor)
