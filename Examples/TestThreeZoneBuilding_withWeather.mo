...
model TestThreeZoneBuilding_withWeather
  ...
  CoSES_Thermal_ProHMo_PHiL.ThermoEnergeticAnalysis.ThreeZoneBuilding_PHiL_optimized_withWeather building(
    redeclare CoSES_Thermal_ProHMo_PHiL.Data.SmallHouse buildingData,
      weatherDataFile="D:/Desktop/MSC-PE/Thesis/THESIS ENS/modelica-ibpsa-master/IBPSA/Resources/weatherdata/DEU_Munich.108660_IWEC.mos",
      useWeatherFile=true,
    T_ambient_fixed=271.15,
    TZoneInit_living=290.15,
  ...
  Modelica.Blocks.Sources.CombiTimeTable occupancy_cellar(
    ...
    annotation(Placement(visible=true, transformation(origin={-200,-74}, extent={{-10,-10},{10,10}}, rotation=0)));
...
equation
  ...
  connect(occupancy_cellar.y[1], building.nPersons_cellar_in)
    annotation(Line(points={{-189,-74},{-120,-74},{-120,-14},{-62,-14}},
                                                                       color={0,0,127}));
...
<p><b>✅ ALL Output Variables Present:</b></p>
<ul>
